import type { NotificationSubRequest, NotificationSubResponse } from "@/types/notification.subs.types";
...
export const createNotificationSub = (request: NotificationSubRequest): Promise<NotificationSubResponse> => {
    return fetchClient<NotificationSubRequest, NotificationSubResponse>("/admin/notification-subscribers", {
        method: "POST",
        body: request,
    });
};
