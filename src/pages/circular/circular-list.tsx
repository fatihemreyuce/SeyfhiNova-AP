...
function SortableRow({ item, onView, onEdit, onDelete, truncateDescription, stripHtml }: SortableRowProps) {
  return (
    <TableRow className="bg-white dark:bg-card border-b border-gray-100 dark:border-border hover:bg-gray-50 dark:hover:bg-muted/30 transition-colors">
  ...
  return (
    <div className="space-y-4 md:space-y-6 pb-4 md:pb-6 px-4 md:px-0">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <Button onClick={() => navigate("/circular/create")} className="w-full sm:w-auto">
