...
function SortableRow({ item, onView, onEdit, onDelete, getCategoryName, truncateText, stripHtml }: SortableRowProps) {
  const {
    attributes,
    listeners,
    setNodeRef,
  ...
  return (
    <div className="space-y-4 md:space-y-6 pb-4 md:pb-6 px-4 md:px-0">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <Button onClick={() => navigate("/service/create")} className="w-full sm:w-auto">
                    ...
                    >
                      {items.map((item) => (
                        <SortableRow
                          ...
                          onEdit={(id) => navigate(`/service/${id}/edit`)}
