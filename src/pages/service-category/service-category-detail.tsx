    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[80vh]">
        <div className="text-center space-y-6">
          ...
          <div>
            <h3 className="text-2xl font-bold mb-2">Kategori bulunamadı</h3>
            <p className="text-muted-foreground">Aradığınız kategori mevcut değil.</p>
          </div>
          <Button variant="outline" onClick={() => navigate("/service-category")} size="lg">
        ...
        <div className="container mx-auto px-4 sm:px-6 py-4">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            ...
            <div className="flex items-center gap-3">
              <Button 
                onClick={() => navigate(`/service-category/${id}/edit`)}
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 rounded-lg bg-primary/10 dark:bg-primary/20 flex items-center justify-center">
                    <Tag className="h-4 w-4 text-primary dark:text-blue-400" />
                  </div>
