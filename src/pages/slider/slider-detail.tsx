...
import { ArrowLeft, Edit, Images, ExternalLink } from "lucide-react";
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold tracking-tight">Slider Detayı</h1>
                  ...
                  <div className="flex flex-col gap-6">
                    ...
                    <div className="flex-shrink-0">
                      <div className="relative group">
                        <div className="w-full h-96 rounded-lg border-2 border-border bg-muted/30 overflow-hidden shadow-sm hover:shadow-md transition-shadow flex items-center justify-center">
                    ...
                    <div className="flex-1 min-w-0 space-y-2">
                      <div className="flex items-center gap-2">
                        <Images className="h-4 w-4 text-muted-foreground flex-shrink-0" />
                        <p className="text-sm font-medium text-foreground">Görsel URL</p>
                      </div>
                      <div className="space-y-1">
                        <p className="text-xs text-muted-foreground">Görsel Dosyası:</p>
              ...
              <Card className="border-2 border-dashed border-border bg-muted/30">
                <CardContent className="p-8">
                  <div className="flex flex-col items-center justify-center text-center space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">Görsel bulunmamaktadır</p>
                  </div>
                </CardContent>
              </Card>
            )}
