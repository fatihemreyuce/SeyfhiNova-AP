    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[80vh]">
        <div className="text-center space-y-6">
          ...
          <div>
            <h3 className="text-2xl font-bold mb-2">Slider bulunamadı</h3>
            <p className="text-muted-foreground">Aradığınız slider mevcut değil.</p>
          </div>
          <Button variant="outline" onClick={() => navigate("/slider")} size="lg">
        ...
        <div className="container mx-auto px-4 sm:px-6 py-4">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            ...
            <div className="flex items-center gap-3">
              <Button 
                onClick={() => navigate(`/slider/${id}/edit`)}
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-3">
            <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-primary/20 to-primary/10 flex items-center justify-center shadow-lg">
              <Images className="h-6 w-6 text-primary dark:text-blue-400" />
            </div>
              ...
              <div className="space-y-3">
                ...
                {imageUrl && (imageUrl.startsWith("http") || imageUrl.startsWith("/")) ? (
                  <div className="relative group/preview">
                    <div className="w-full h-80 rounded-2xl border-2 border-border/50 dark:border-border/70 bg-gradient-to-br from-muted/40 to-muted/20 dark:from-muted/60 dark:to-muted/40 overflow-hidden shadow-lg group-hover/preview:border-primary/50 dark:group-hover/preview:border-primary/60 transition-all duration-300 flex items-center justify-center">
                      <img
                        src={imageUrl}
                        alt={data.title}
                          ...
                          if (parent) {
                            parent.innerHTML = `
                              <div class="flex flex-col items-center justify-center w-full h-full text-muted-foreground dark:text-muted-foreground/60">
                                ...
                                <span class="text-sm font-medium">Görsel yüklenemedi</span>
                              </div>
                            `;
                          }
                        }}
                  ...
                  <div className="w-full h-80 rounded-2xl border-2 border-dashed border-border/50 dark:border-border/70 bg-gradient-to-br from-muted/30 to-muted/10 dark:from-muted/50 dark:to-muted/30 flex items-center justify-center group-hover:border-primary/50 dark:group-hover:border-primary/60 transition-all duration-300">
                    <div className="flex flex-col items-center text-center space-y-4">
                      <div className="w-20 h-20 rounded-2xl bg-muted/50 dark:bg-muted/70 flex items-center justify-center border-2 border-border/50">
                        <Images className="h-10 w-10 text-muted-foreground dark:text-muted-foreground/60" />
                      </div>
                      <div>
