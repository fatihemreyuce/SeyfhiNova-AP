  ...
  return (
    ...
    >
      ...
      <TableCell className="py-1.5">
        {item.imageUrl ? (
          <div className="flex items-center justify-center w-16 h-12 rounded-md overflow-hidden bg-muted border border-border">
            <img
          ...
          <div className="w-16 h-12 rounded-md bg-muted/50 border border-border flex items-center justify-center">
            <Images className="h-4 w-4 text-muted-foreground opacity-50" />
          </div>
        )}
      </TableCell>
      <TableCell className="py-1.5">
        <span className="font-medium text-sm dark:text-foreground max-w-xs truncate">
          {item.title}
        </span>
      </TableCell>
  ...
  return (
    <div className="space-y-4 md:space-y-6 pb-4 md:pb-6 px-4 md:px-0">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <Button onClick={() => navigate("/slider/create")} className="w-full sm:w-auto">
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col items-center justify-center py-16 rounded-lg border border-dashed">
          ...
          <h3 className="text-lg font-semibold dark:text-foreground mb-2">
            {searchInput ? "Sonuç bulunamadı" : "Henüz slider yok"}
          </h3>
                ...
                <Table>
                  <TableHeader>
                    <TableRow className="bg-[#F8F9FA] dark:bg-muted/30 border-b border-gray-200 dark:border-border">
                      ...
                      <TableHead className="w-[100px] h-9 py-2 text-xs font-medium">Görsel</TableHead>
